...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Tropica - Admin & Dashboard Template</title>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Tropica.</p>
                                </div>
                                <!-- Danger Alert -->
                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{ route('admin.login') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="email" id="username" value="{{ old('email') }}" placeholder="Enter Email">
                                        </div>
                                        @error('email')
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Tropica. Crafted with <i class="mdi mdi-heart text-danger"></i> by Techwelfare
                            </p>
                        </div>
                    </div>
                </div>
