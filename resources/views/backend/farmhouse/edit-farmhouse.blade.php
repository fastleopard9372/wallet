        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit House Form</h4>
                    
                </div><!-- end card header -->
                <div class="card-body">
              
                    <div class="live-preview">
                        <form action="{{route('admin.farmhouse.update')}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
...
<script>
    ...
    function multipleImg() {
        let farmhouse_id='{{$details->id}}';
        $.ajax({
            url: "{{ route('admin.farmhouse.multiple.images') }}",
            type: "GET",
            data: {
