                            ...
                            <tbody>
                                @foreach ($data as $list)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$list->user_id}}</td>
                                        <td>{{$list->txn_id}}</td>
                                        <td> <i id="StatusShow_{{ $list->id }}" class="@php if($list->status==1){echo 'ri-checkbox-circle-line align-middle text-success';}else{ echo 'ri-close-circle-line align-middle text-danger';} @endphp"></i>Approved</td>
