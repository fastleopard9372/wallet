    ...
    <div class="container">
        <div class="header__inner" data-controller="nav">
            ...
            <div class="header__actions">
                ...
                <a href="/investment/account/service.html" class="header__connect-icon btn btn--secondary btn--raised btn--sm">
                    <svg fill="#ffffff" width="18px" height="18px" viewBox="-2.3 0 122.88 122.88" version="1.1"
