        ...
        <div class="footer_cols">
            <div class="footer_cols_left wow fadeIn" data-wow-delay="0.2s"
                ...
                <div class="footer_logo">
                    <a href="#">
                        <img data-src="{{ URL::asset('frontend/img/logo.svg')}}" src="{{ URL::asset('frontend/img/logo.svg')}}" class="js-img"
                ...
                <div class="footer_soc">
                    ...
                    <div class="soc">
                        <a href="https://t.me/unijoin" class="soc_item" target="_blank"><svg
                                class="svg-inline--fa fa-telegram-plane fa-w-14" aria-hidden="true"
                                focusable="false" data-prefix="fab" data-icon="telegram-plane" role="img"
                        ...
                        <a href="https://www.youtube.com/channel/UCCEfChYfcmcOy8sulHPWt6w" class="soc_item"
                            target="_blank">
                            <svg class="icon">
                        ...
                        <a href="https://www.reddit.com/r/UniJoin/" class="soc_item" target="_blank">
                            <svg class="svg-inline--fa fa-reddit fa-w-16" aria-hidden="true" focusable="false"
