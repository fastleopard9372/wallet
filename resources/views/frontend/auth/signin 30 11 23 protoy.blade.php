...
<body>
  ...
  <div class="auth-modal">
    ...
    <form action="#" class="auth-form" id="signin_form" name="signin_form">
      ...
      <div class="form-control auth-btn-group">
        <button type="button" class="auth-btn active">Log in</button>
        <a href="/investment/signup.html" class="auth-btn">Sign up</a>
      </div>
    </form>
...
<script type="text/javascript" src="{{ URL::asset('frontend/jquery/jquery-3.6.4.min.svg')}}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/jquery/jquery-ui.svg')}}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/js/kit.fontawesome.svg')}}"></script>
<script src="{{ URL::asset('frontend/libs/Semantic/fomantic-ui-css/semantic.min.svg')}}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"></script>
<script src="{{ URL::asset('frontend/js/additional.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/aos.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/slick.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/vendors.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/app.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/lottie-player.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/main.svg')}}"></script>
<script src="{{ URL::asset('frontend/js/animate_text.svg')}}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/js/slide.svg')}}"></script>
<script type="text/javascript" src="{{ URL::asset('frontend/libs/html2canvas-master/dist/html2canvas.svg')}}"></script>
