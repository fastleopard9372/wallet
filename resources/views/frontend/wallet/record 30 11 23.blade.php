...
<body class="record">
  <header>
    <a href="{{ route('wallet_index') }}" class="back"><svg fill="#333333" height="20px" width="20px" version="1.1"
        id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
        xml:space="preserve" stroke="#333333">
  ...
  <section class="record_lists">
    <div class="rec_list">
      ...
      <div class="rec_content">
        <div class="rec_type">
          <div class="rtp">Withraw</div>
          <div class="rtpr">
            <div style="margin-left: 85px" class="rec_min">-750.00</div>
    ...
    <div class="rec_list">
      ...
      <div class="rec_content">
        <div class="rec_type">
          <div class="rtp">Rewards</div>
          <div class="rtpr">
            <div style="margin-left: 85px">-750.00</div>
            <div style="text-align: center; font-size: 14px">Transfer:COIN. $0.67</div>
          </div>
        </div>
      </div>
    ...
    <div class="rec_list">
      ...
      <div class="rec_content">
        <div class="rec_type">
          <div class="rtp">Rewards</div>
          <div class="rtpr">
            <div style="margin-left: 85px" class="rec_plus">+50.00</div>
            <div style="text-align: center; font-size: 14px">Transfer:COIN. $0.67</div>
          </div>
        </div>
      </div>
