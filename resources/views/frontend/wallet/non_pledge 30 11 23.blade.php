  ...
  <main>
    ...
    <div class="balance-box">
      <div class="point" style="text-align: center">
        <div style="display: flex; align-items: center; align-content: center">
          ...
          <a href="/investment/wallet/record.html" style="margin-left: auto; margin-right: 10px">
      ...
      <div class="transfer">
        <a href="/investment/wallet/out.html" class="btnout">OUT</a>
        <a href="/investment/wallet/in.html" class="btnin">Withraw</a>
      </div>
    </div>
    ...
    <div class="rule">
      ...
      <ol>
        ...
        <li>Daily net income 1 %.</li>
        <li>Total net income 90 %.</li>
