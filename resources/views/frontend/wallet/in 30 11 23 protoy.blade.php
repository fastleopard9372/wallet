...
<body class="record">
  ...
  <section class="total">
    ...
    <div class="coin">
      ...
      <div style="width: 65%">
        <input type="number" value="0.00" id="total_coin" style="width: 100%" />
      </div>
      <div style="width: 25%">
  ...
  <section class="total">
    ...
    <div class="coin">
      <div style="width: 15%">COIN.</div>
      <div style="width: 65%">
        <input type="number" value="100.00" id="transfer_coin" style="width: 100%" />
      </div>
    </div>
    <button style="width: 100%; background-color: #68c9fa; padding: 10px; margin-top: 20px; border-radius: 5px">
      OK
    </button>
  </section>
