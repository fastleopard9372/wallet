...
<body class="pledge">
  ...
  <main>
    ...
    <div class="pleday">
      <img src="{{ URL::asset('frontend/images/wallet/pleday.png')}}" alt="pleday" width="100%" />
    </div>

    <div class="income_period_btn">
      <button>INCOME PERIOD</button>
    </div>
    <div style="padding: 0 20px">
      ...
      @else
      {{date("Y-m-d H:i:s").' - '.date("Y-m-d H:i:s", strtotime('+180 day'))}}
      @endif
      <div class="timeline">
        <div>
      ...
      <div class="timer_box">
        ...
        $days=[];
        @endphp
        @foreach($data['pledge'] as $item)
        <?php
          $last_date = date('Y-m-d H:i:s', strtotime('+180 day', strtotime($item->created_at)));
        ...
        <div class="timer">
          <div>
            <div id="timer_day_{{$length-1}}">180</div>
            <div>D</div>
          </div>
          <div>
            <div>:</div>
        ...
        <form action="{{route('pledge_insert')}}" method="post" id="pledge_form">
          @csrf
          <input type="hidden" value="1" name="kind">
          <input type="hidden" value="180" name="date">
          <input type="hidden" value="1.3" name="income">
      ...
      <div class="rule">
        <h3>Rules for pledge :</h3>
        <ol>
          <li>Investment between $20 - $10,000.</li>
          <li>Daily net income 1.3 %</li>
          <li>Total net income 234 %.</li>
          <li>Investment period 180 days.</li>
      ...
      <div class="qa">
        ...
        <ol>
          ...
          <p>
            ...
            <br />
            <br />
            For example, your investment is 1000$ and you earned 1.3% daily from X-wallet (pledge mode). If you reach
            gold league, your daily income automatically will increase 1.3% to 1.8%.
          </p>
        </ol>
