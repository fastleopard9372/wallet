...
<body>
  ...
  <section class="detail_rec">
    ...
    <a href="{{route('projects.giogame')}}">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/02.png')}}" alt="rec_02" />
      <h4>Gio-Gamer</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <a href="{{route('projects.spectaapp')}}">
    ...
    <a href="{{route('projects.eggzomania')}}">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/08.png')}}" alt="rec_08" />
      <h4>Eggzo Mania</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <a href="{{route('projects.quopi')}}">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="rec_11" />
      <h4>Quopi</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <a href="{{route('projects.centrium')}}">
    ...
    <a href="{{route('projects.future_trades')}}">
