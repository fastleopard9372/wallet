...
<head>
  ...
  <title>Meme Season - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Meme Season</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/ad2/15.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/15.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/15.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/15.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/15.jpg')}}" alt="detail_rec_03" width="80%" />
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .10.11.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <p>
          Bitcoin: $10, Ethereum: $15, Litecoin: $5, Tether ERC20: $15, Tether TRC20: $3, Tether BEP20: $5, Tron: $3,
          BNB: $5, Dogecoin: $3.
        </p>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Meme Season</h3>
      <div style="padding: 10px 20px">
        Founded by lifelong friends Joh Hass and Mark Douglas, <b>Memeseason.io</b> is the culmination of their
        collective expertise in the cryptocurrency market. Joh, the CEO, brings a successful trading history dating
        back to 2017, while Mark, Head of the Trading Department, adds his strategic prowess to the mix. Together,
        their friendship and shared passion form the foundation of <b>Memeseason.io</b>, a platform designed for
        transparent and successful memecoin investments. <br /><br />
        Founded in October 2023, our journey began with a vision to revolutionize memecoin investments and bring a
        unique perspective to the market. Having successfully conducted a private offering in October with an initial
        target of $10,000,000, we have proudly opened our doors to the public through our dynamic online program. This
        strategic move marks a pivotal moment in our commitment to sharing the benefits of memecoin investments with a
        wider audience. <br /><br />
        What sets <b>Memecoin.io</b> apart is our unparalleled advantage in the market. We've been actively navigating
        the memecoin landscape privately for an extended period, giving us an intricate understanding of the market
        dynamics. This in-depth knowledge enables us to distinguish promising memecoin projects from fleeting scams,
        ensuring that we focus our investments on projects with genuine potential. <br /><br />
        At Memecoin.io, transparency, security, and sustainable growth are at the core of our values. As we continue
        to evolve and adapt to the dynamic world of cryptocurrencies, our seasoned team remains dedicated to providing
        you with a trustworthy platform for memecoin investments.
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/memeseason/01.jpg')}}" alt="memeseason_1"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/memeseason/02.jpg')}}" alt="memeseason_2"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/memeseason/03.jpg')}}" alt="memeseason_3"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/memeseason/04.jpg')}}" alt="memeseason_4"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/memeseason/05.jpg')}}" alt="xedmex_5" width="100%" />
      </div>
    </div>
  </section>
  ...
  <section class="reviews">
    <div class="accept_pay">
      ...
      <div>
        ...
        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/social/medium-svg.png')}}" alt="medium-svg" />
