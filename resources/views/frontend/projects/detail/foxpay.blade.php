...
<head>
  ...
  <title>Fox Pay - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="fox_pay_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="fox_pay_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="fox_pay_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="fox_pay_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="fox_pay_03" width="80%" />
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : 19.08.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <ol>
          <li>AI income - 1% per day and (capital at any time).</li>
          <li>Fixed DeFi cycle - 2.7% per day( capital and income end-of-cycle ) .</li>
          <li>Flexible DeFi cycle - daily income of up to 1.7% (capital with a maturity of up to 80 days )</li>
        </ol>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - 15%</div>
        </div>
      </div>
    </div>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Fox Pay</h3>
      <div style="padding: 10px 20px">
        Since December 2022, we have been working on developing the best global exchange. Listed after nine months of
        preparation, we have a world-leading trading system that continues to set new standards with advances in
        neural network mathematics and methodology. However, for FOXPAY, this is just the beginning. We will continue
        to leverage our expertise in artificial intelligence and neural networks to create technologies that make
        investing faster, better and easier. <br /><br />
        What FOXPAY needs to do is to become a refined and agile data-driven financial technology company. We will not
        introduce a huge trading clearing room and bloated internal IT structure - we will only cooperate with trusted
        professionals and output the best results. <br /><br />
        We will continue to provide the strength of high-quality intelligent asset management tools, so that all users
        can grow wealth faster on FOX PAY.
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/foxpay/01.jpg')}}" alt="foxpay_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/foxpay/02.jpg')}}" alt="foxpay_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/foxpay/03.jpg')}}" alt="foxpay_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/foxpay/04.jpg')}}" alt="foxpay_4" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/foxpay/05.jpg')}}" alt="foxpay_5" width="100%" />
      </div>
    </div>
  </section>
