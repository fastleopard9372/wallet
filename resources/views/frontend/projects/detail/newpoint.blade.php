...
<head>
  ...
  <title>New Point - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">New Point</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/ad2/02.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/02.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/02.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/02.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/ad2/02.jpg')}}" alt="detail_rec_03" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>1500+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .02.07.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <p>From 3.2% daily for 30 days (capital returned)</p>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - depends on rules</div>
        </div>
      </div>
    </div>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about New Point</h3>
      <div style="padding: 10px 20px">
        New point is a company that builds an open metaverse through NFT and innovative media ecology. Founded in
        Silicon Valley, USA, based on the overall framework of X to earn: through running clock management, advocating
        a healthy lifestyle, and issuing tokens for incentives, and working hard to achieve the goal of global carbon
        neutrality; watch and engage to earn, attention Realize the innovation of the media paradigm through reading
        and browsing, move towards the new media ecology of the web3 metaverse, build a bridge from traditional media
        to new media, and take "creating unique value for each brand" as the corporate brand concept, Launched the
        "Global Spark Drainage Program", formed a community fan group of millions, shared industry benefits globally,
        made money by watching advertisements, shared profits by participating, shared and obtained wealth, and
        created and shared three major channels of income: advertising fees, brand rebates , Channel dealers share
        profits. A new starting point, focusing on building the advertising ecology of the Web3.0 metaverse, from
        strategic design to user data, marketing tools, and creative communication to achieve a closed loop, thereby
        stimulating the infinite future of the advertising industry. <br /><br />
        New Point, through the traffic base of the New Point platform and daily users viewing ads news and other
        behavior, will attract more partners to help partners and merchants promote advertising, launch joint
        activities or products, or direct users to use service partners of these companies. Share your results.
        <br /><br />
        Xindian guides users to develop exercise habits through the concept of exercise and health. After that, you'll
        work with top events, help promote and advertise them, earn event promotion commissions, and export courses.
        The platform includes sports equipment sellers, health supplement providers, etc. May be associated with
        fitness or sports related brands or companies such as. The platform includes sports equipment providers,
        health food brands, etc. May be associated with fitness or sports related brands or companies such as.
        <br /><br />
        Xindian is a platform that helps users develop good reading habits through reading revenue, provides paid
        subscriptions for users to read more content or get an improved reading experience, provides new books, and
        helps authors and publishers promote their books. At the same time, the platform will organize its own events
        for different sectors, develop relevant IPs and generate event revenue through member participation.
        <br /><br />
        NEW POINT has been recognized by authoritative organizations, has successfully obtained the California
        registration certificate and the US digital currency license (MSB), which not only represents the legitimacy
        and reliability of the company, but also highlights the strength and advantages of the company. <br /><br />
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/newpoint/01.jpg')}}" alt="newpoint_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/newpoint/02.jpg')}}" alt="newpoint_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/newpoint/03.jpg')}}" alt="newpoint_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/newpoint/04.jpg')}}" alt="newpoint_4" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/newpoint/05.jpg')}}" alt="newpoint_5" width="100%" />
      </div>
    </div>
  </section>
