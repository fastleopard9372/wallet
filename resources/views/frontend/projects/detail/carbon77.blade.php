...
<head>
  ...
  <title>Carbon 77 - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Carbon 77</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>1900+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .05.10.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <ol>
          <li>2.17% Daily for 7 Days ; 10$ - 500$ (capital returned)</li>
          <li>2.77% Daily For 14 Days ; 50$ - 5,000$ (capital returned)</li>
          <li>7.77% Daily For 7 Days ; 1,000$ - 10,000$ ( capital returned)</li>
        </ol>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - 5% +3% +2% +1% +1%</div>
        </div>
      </div>
    </div>
    <div class="withraw_fee">
      <div>Withdrawal fee - 0 (no fee)</div>
      <div>Arrival Time - 24 ~ 48 hours</div>
    </div>
    <hr />
  ...
  <section class="project_highlights">
    <div>
      <h3>FFacts about Carbon 77</h3>
      <div style="padding: 10px 20px">
        The arbitrage bot simultaneously works with 12 cryptocurrency exchanges, scanning various pairs of
        cryptocurrencies and choosing the most profitable combinations for making a profit. Carbon77 has managed to
        develop an arbitration bot that can act effectively and make decisions regardless of the market
        situation.<br /><br />
        The mission of our company is to provide as many people as possible with the opportunity to get acquainted
        with arbitrage trading without the need for active participation and study of this topic. <br /><br />
        CARBON GROUP LIMITED registered in the United Kingdom benefits from a high level of legal protection and
        reliability. <br />
        <b>COMPANY NUMBER 05834909</b> <br /><br />
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/carbon77/01.jpg')}}" alt="carbon77_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/carbon77/02.jpg')}}" alt="carbon77_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/carbon77/03.jpg')}}" alt="carbon77_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/carbon77/04.jpg')}}" alt="carbon77_4" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/carbon77/05.jpg')}}" alt="carbon77_5" width="100%" />
      </div>
    </div>
  </section>
    ...
    <div class="accept_pay">
      <div>
        ...
        <div>
          ...
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="trc" />
