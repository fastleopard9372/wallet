...
<html lang="en">
  <head>
    ...
    <title>Trade 24 - Project Detail</title>
  </head>
  <body>
    ...
    <section>
      <div class="project_info">
        <h1 class="fontcolor">Trade 24</h1>
...
="detail01" />
      ...
      <div class="detail_images">
        <img src="{{ URL::asset('frontend/images/project/ad2/11.jpg')}}" alt
...
="question-svgrepo-com" />
      ...
      <div class="withraw_content">
        <div class="started">
          <button>Started : .14.10.2023</button>
          <button class="paying">
...
="insurance" width="80px" />
    ...
    <section class="project_highlights">
      <div>
        <h3>Facts about Trade 24</h3>
        <div style="padding: 10px 20px">
          Investing wisely is a key component of building long-term financial success. With Trade24, investors gain
          access to a comprehensive platform that empowers them to make informed investment decisions and seize
          profitable opportunities. This article serves as a guide to help you unleash the power of Trade24 and embark
          on a successful investing journey. <br /><br />
        </div>
        <div class="project_description">
          <img src="{{ URL::asset('frontend/images/project/detail/trade24/01.jpg')}}" alt
="trade24_1" width="100%" />
          <img src="{{ URL::asset('frontend/images/project/detail/trade24/02.jpg')}}" alt
="trade24_2" width="100%" />
          <img src="{{ URL::asset('frontend/images/project/detail/trade24/03.jpg')}}" alt
="trade24_3" width="100%" />
          <img src="{{ URL::asset('frontend/images/project/detail/trade24/04.jpg')}}" alt
="trade24_4" width="100%" />
          <img src="{{ URL::asset('frontend/images/project/detail/trade24/05.jpg')}}" alt
="trade24_5" width="100%" />
        </div>
      </div>
    </section>
...
="usdt_trc20" />
        ...
        <div>
          ...
          <div>
            <img src="{{ URL::asset('frontend/images/project/detail/social/whatsapp-svg.png')}}" alt
="whatsapp-svg" />
