...
<head>
  ...
  <title>Cen-Trium - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Cen-Trium</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="detail_rec_03" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>1000+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .05.11.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <div>
          ...
          <div><b>Minimum Withdrawal</b> - 5$</div>
        </div>
        <ol>
          <li>2.2% for 15 days business days (Monday - Friday) & (deposit returned)</li>
          <li>2.4% for 25 days business days (Monday - Friday) & (deposit returned)</li>
          <li>2.8% daily for 35 business days (Monday - Friday) & (deposit returned)</li>
          <li>6% + 2% + 1% + 1%</li>
        </ol>
        ...
        <p>1.2% - 5% for 30 business days (Monday - Friday) & (capital returned)</p>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Cen-Trium</h3>
      <div style="padding: 10px 20px">
        Cen-Trium, founded in 2023, stands as a beacon of innovation in the realm of investment management. Born from
        a vision of transforming traditional investment paradigms, Cen-Trium has quickly risen to prominence as a
        leading force in the cryptocurrency market. With a foundation built on cutting-edge technology and strategic
        foresight, Cen-Trium sets new standards in the investment industry. <br /><br />
        Cen-Trium's core focus revolves around harnessing the immense potential of the cryptocurrency market. Guided
        by meticulous research and analysis, the company identifies and seizes promising investment opportunities
        within the dynamic world of digital assets. Cen-Trium's expertise extends beyond mere investments. The company
        actively engages in trading cryptocurrencies on various exchanges, leveraging market trends to optimize
        returns for its clients. <br /><br />
        At the heart of Cen-Trium's success lies its proprietary marvel, the Cen-Trium Bot. This state-of-the-art
        trading bot, fortified with artificial intelligence and machine learning, revolutionizes the investment
        landscape. Cen-Trium Bot doesn't merely trade, it strategizes. By assimilating vast datasets, it predicts
        market movements, executes trades with unmatched precision, and maximizes profits for investors. This fusion
        of cutting-edge technology and financial acumen positions Cen-Trium at the forefront of profit-making in the
        cryptocurrency arena. <br /><br />
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/centrium/01.jpg')}}" alt="centrium_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/centrium/02.jpg')}}" alt="centrium_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/centrium/03.jpg')}}" alt="centrium_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/centrium/04.jpg')}}" alt="centrium_4" width="100%" />
      </div>
    </div>
  </section>
