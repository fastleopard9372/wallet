...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Banter Bits</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="startfrom_15" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="startfrom_15" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="startfrom_15" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="startfrom_15" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="startfrom_15" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>1209+ registered last 30 days</div>
    </div>
    <hr />
  </section>
    ...
    <div class="withraw_content">
      ...
      <div class="minimum_list">
        ...
        <div>
          ...
          <div><b>Minimum Withdrawal</b> - 1$</div>
        </div>
        ...
        <ol>
          <li>2.1 % daily for Lifetime ; 5$ - 299$ (capital returned )</li>
          <li>4.2% daily for 45 days ; 300$ - 1,999$ (capital returned)</li>
        </ol>
      ...
      <p>5% + 3% + 1% + 0.5% + 0.5% (depending on the level of your affiliate)</p>
    </div>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Banter Bits</h3>
      <div style="padding: 10px 20px">
        BanterBits was founded in 2022 in Leighton Buzzard, England by a team of professional crypto traders. We
        specialize in profitable trading of digital assets using neural networks and proprietary algorithmic robots.
        Based on positive cases, the neural network analyzes the potential of a particular cryptocurrency for the
        current time, and the trading robot makes a lot of short-term transactions, lasting no more than a day,
        extracting maximum profit in the shortest possible time. <br /><br />
        This strategy is called scalping, and it allows you to profit even when the price of an asset changes
        insignificantly. <br /><br />
        Scalping strategy is a popular technique in cryptocurrency trading, which aims to generate small but frequent
        profits by quickly buying and selling assets. Despite the fact that the income from a single trade is rarely
        large, conducting thousands of trades at a time gives excellent profits. <br /><br />
        In 2023 we launched our investment platform <b>banterbits.pro</b>, where anyone can make money on
        cryptocurrencies without any experience. We have formed 3 investment plans with different terms and yields up
        to 6.4% per day. At the moment, the platform has more than a thousand satisfied investors, with whom we share
        our profits every day.<br /><br />
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/banterbits/01.jpg')}}" alt="banterbits_1"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/banterbits/02.jpg')}}" alt="banterbits_2"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/banterbits/03.jpg')}}" alt="banterbits_3"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/banterbits/04.jpg')}}" alt="banterbits_4"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/banterbits/05.jpg')}}" alt="banterbits_5"
          width="100%" />
      </div>
    </div>
  </section>
    ...
    <div class="accept_pay">
      <div>
        ...
        <div>
          ...
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="etherieum" />
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="bitcoincash" />
          ...
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="thther" />
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="tron" />
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="qiwi" />
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="yoomoney" />
          <img src="{{ URL::asset('frontend/images/project/detail/coins/x.png')}}" alt="bankcards" />
        </div>
      </div>
      <div>
