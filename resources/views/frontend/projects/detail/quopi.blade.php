...
<head>
  ...
  <title>Quopi - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="detail_rec_11" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="detail_rec_11" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="detail_rec_11" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="detail_rec_11" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/11.png')}}" alt="detail_rec_11" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>1200+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .01.02.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        ...
        <p>1.5% ~ 4.0% for 30 business days (Monday - Friday) & (deposit returned)</p>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - 5% & upto 15%</div>
        </div>
      </div>
    </div>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Quopi :</h3>
      <div style="padding: 10px 20px">
        Quopi AI is the pioneering trading bot developed by Quopi Ltd., a UK based financial software company. It
        represents a groundbreaking fusion of GPT models and expert trading guidance. <br /><br />
        Quopi AI trading bot was developed by collecting and preprocessing financial data, including news articles,
        historical stock prices and educational content on GPT. This data was used to train the GPT model, which was
        then used to develop trading rules and strategies based on the insights gained from the data. After multiple
        iterations, and backtesting of the trading bot on historical trading data, the Quopi AI trader was released
        live on January 4th, 2023. Since it's unveiling, the trading bot has performed with a high success rate, and
        never closed a single day of trading without a net profit. <br /><br />
        Quopi AI started as a proof of concept, and at this point has grown to a promising trading tool accessible to
        any interested user, with or without prior trading background. We have harnessed the power of Artificial
        Intelligence to create a cutting-edge trading solution, which is available to anyone interested through the
        Quopi web application and the Quopi AI app for Android users. iOS app TBA.
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/quopi/01.jpg')}}" alt="quopi_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/quopi/02.jpg')}}" alt="quopi_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/quopi/03.jpg')}}" alt="quopi_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/quopi/04.jpg')}}" alt="quopi_4" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/quopi/05.jpg')}}" alt="quopi_5" width="100%" />
      </div>
    </div>
  </section>
