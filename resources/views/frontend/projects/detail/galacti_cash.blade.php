...
<head>
  ...
  <title>Galacti Cash - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Galacti Cash</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/toprated/05.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/toprated/05.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/toprated/05.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/toprated/05.jpg')}}" alt="detail_rec_03" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/toprated/05.jpg')}}" alt="detail_rec_03" width="80%" />
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .06.11.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        <div>
          ...
          <div><b>Minimum Deposit</b> - 20$</div>
        </div>
        ...
        <div>
          ...
          <div><b>Income Returns</b> - 6% ~ 10% for daily</div>
        </div>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - 15% + 5% +2%</div>
        </div>
      </div>
    </div>
    <div class="withraw_fee">
      <div>Withdrawal fee - 5%</div>
      <div>Arrival Time - 72 hours</div>
    </div>
    <hr />
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Galacti Cash</h3>
      <div style="padding: 10px 20px">
        GALACTICASH is a young and dynamic digital currency company located in Denver, Colorado, USA. Our registered
        capital is US$50 million, which is a reflection of our strength.
        <br /><br />
        Our team is composed of a group of young people with innovative spirit and professional knowledge. They
        wholeheartedly provide users with high-quality services, constantly optimize our services and technology, and
        provide users with a safer and more convenient trading experience.
        <br /><br />
        At GALACTICASH, we uphold the core values of innovation, security, and user first, and strive to create a
        safe, convenient, and rich digital currency trading platform to provide the best services to global users. Our
        goal is to allow every user to find satisfactory digital currency investment opportunities in GALACTICASH. We
        also hope that through our efforts, digital currency will become the choice of more people and contribute to
        global economic development.
        <br /><br />
        We always believe that with the continuous development and popularity of digital currency, GALACTICASH will
        become an industry leader and make important contributions to the future of digital currency. We also hope
        that through our efforts, digital currency will become the choice of more people and contribute to global
        economic development. We welcome you to join us and create a bright future of digital currency together!
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/galacti_cash/1.jpg')}}" alt="galacti_cash_1"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/galacti_cash/2.jpg')}}" alt="galacti_cash_2"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/galacti_cash/3.png')}}" alt="galacti_cash_3"
          width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/galacti_cash/4.png')}}" alt="galacti_cash_4"
          width="100%" />
      </div>
    </div>
  </section>
