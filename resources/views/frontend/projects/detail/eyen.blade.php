...
<body>
  ...
  <section>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="detail_rec_06" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="detail_rec_06" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="detail_rec_06" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="detail_rec_06" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="detail_rec_06" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>22000+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : 20.10.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        <div>
          ...
          <div><b>Minimum Deposit</b> - 269$</div>
        </div>
        ...
        <div>
          ...
          <div><b>Income Returns</b> -3.06% for daily</div>
        </div>
        ...
        <p>2% ~ 50% (depends on inviting people)</p>
      </div>
    </div>
    <div class="withraw_fee">
      <div>Withdrawal fee - minimum gas fee apply upon withdrawal</div>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Eyen</h3>
      <div style="padding: 10px 20px">
        Earn rewards by watching videos, and there are a variety of built-in games. <br /><br />
        EYE-N, also referred to as EYE-EARN, which stands for earning income through your eyes. It's a cutting-edge
        web3 life application that seamlessly merges short videos with NFT and gives everyone a sustainable income in
        the world. <br /><br />
        As a comprehensive platform, whether catering to aficionados of short videos, content creators, NFT
        enthusiasts, or anyone else, EYE-N serves as a diverse, engaging, and invaluable companion in the life. EYE-N
        is committed to creating an inclusive, equitable, and transparent ecosystem that enables users to derive real
        value. By combining short video functionality with NFT technology, it not only allows users to watch, create,
        and share short videos, but also provides them with a more enriched and valuable experience, offering
        opportunities and incentives to engage in the web3 economy. <br /><br />
        With the advent of the AI era, many jobs face challenges of being replaced by AI, which will cause countless
        people to lose their stable income. EYE-N provides a reliable solution, helping those who have lost their jobs
        due to AI replacement to rediscover income sources, expanding economic opportunities, enabling everyone to
        have control over their income regardless of country or background. <br /><br />
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/eyen/01.jpg')}}" alt="xedmex_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/eyen/02.jpg')}}" alt="xedmex_2" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/eyen/03.jpg')}}" alt="xedmex_3" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/eyen/04.jpg')}}" alt="xedmex_4" width="100%" />
      </div>
    </div>
  </section>
