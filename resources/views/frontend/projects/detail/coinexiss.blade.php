...
<head>
  ...
  <title>Coinexiss - Project Detail</title>
</head>
...
<body>
  ...
  <section>
    <div class="project_info">
      <h1 class="fontcolor">Coinexiss</h1>
    ...
    <div class="detail_images">
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="startfrom_14" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="startfrom_14" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="startfrom_14" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="startfrom_14" width="80%" />
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="startfrom_14" width="80%" />
    ...
    <div class="detail_people">
      ...
      <div>150+ registered last 30 days</div>
    </div>
    <hr />
  </section>
  ...
  <section class="project_cashback">
    ...
    <div class="withraw_content">
      <div class="started">
        <button>Started : .20.11.2023</button>
        <button class="paying">
      ...
      <div class="minimum_list">
        <div>
          ...
          <div><b>Minimum Deposit</b></div>
        </div>
        <p>(5$ in TRON,XLM), (10$ LTC,BNB,RIPPLE,USDT BEP20,USDT TRC20) , (50$ BITCOIN).</p>
        ...
        <ol>
          <li>3.3 % daily for 55 days ; 10$- 55$ (capital included)</li>
          <li>4.2% daily for 45 days ; 55$ - 2,999$ (capital included)</li>
          <li>6% daily for 35 days ; 2,999$ - 50,000$ ( capital included)</li>
        </ol>

        <div>
          <img src="{{ URL::asset('frontend/images/project/detail/calendar.svg')}}" alt="calendar" />
          <div><b>Affiliate Income</b> - 5.4% + 2%</div>
        </div>
      </div>
    </div>
    ...
    <div class="high_lights_list">
      ...
      <ul>
        <li><b>Trusting Score</b> - 30%</li>
        <li><b>Running days</b> - 2</li>
  ...
  <section class="project_highlights">
    <div>
      <h3>Facts about Coinexiss</h3>
      <div style="padding: 10px 20px">
        <b>coinexiss.com</b> investment platforms as of present day is a user-friendly platform that allows everyone
        participate and securely earn from our various investment packages, including our High referral system you're
        not just entrusting your assets <br /><br />
        you're partnering with a visionary team committed to delivering up to an astounding 3.3% to 6% daily confirm
        profit.
      </div>
      <div class="project_description">
        <img src="{{ URL::asset('frontend/images/project/detail/coinexiss/01.jpg')}}" alt="coinexiss_1" width="100%" />
        <img src="{{ URL::asset('frontend/images/project/detail/coinexiss/02.jpg')}}" alt="coinexiss_2" width="100%" />
      </div>
    </div>
  </section>
