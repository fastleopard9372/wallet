...
<body>
  ...
  <div class="detail_rec_result">
    <h3>Mining (16 Results)</h3>
  </div>

  <section class="detail_rec">
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/01.png')}}" alt="mining_01" />
      <h4>SLOMINING</h4>
      <p>
        More infomation
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/02.png')}}" alt="mining_02" />
      <h4>topHash</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/03.png')}}" alt="mining_03" />
      <h4>Globale Crypto</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
      </p>
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/04.png')}}" alt="mining_04" />
      <h4>BitFuFu</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/05.png')}}" alt="mining_05" />
      <h4>NGS Crypto</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/06.png')}}" alt="mining_06" />
      <h4>ECOS Mining</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/07.png')}}" alt="mining_07" />
      <h4>Hashshiny</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/08.png')}}" alt="mining_08" />
      <h4>ID Mining</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/09.png')}}" alt="mining_09" />
      <h4 class="ft14">USDT Mining Miner</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
      </p>
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/10.png')}}" alt="mining_10" />
      <h4>IQ Mining</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/11.png')}}" alt="mining_11" />
      <h4>Asignat Fund</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/12.png')}}" alt="mining_12" />
      <h4>Bitcoin Minetrix</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
      </p>
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/13.png')}}" alt="mining_13" />
      <h4>BeMine</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/14.png')}}" alt="mining_14" />
      <h4>Trust Mining</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/15.png')}}" alt="mining_15" />
      <h4>Kryptex</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/mining/16.png')}}" alt="mining_16" />
      <h4>F2 Hash</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
