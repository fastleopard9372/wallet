...
<body>
  ...
  <div class="detail_rec_result">
    <h3>Insured (20 Results)</h3>
  </div>

  <section class="detail_rec">
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/01.jpg')}}" alt="rec_01" />
      <h4>X-Wallet</h4>
      <p>
        More infomation
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/13.png')}}" alt="rec_13" />
      <h4>X-weeks</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/04.png')}}" alt="rec_04" />
      <h4>G-miner</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/11.png')}}" alt="start_from_11" />
      <h4>Green Tourism</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/12.png')}}" alt="rec_12" />
      <h4>Royal Q</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/09.png')}}" alt="start_from_09" />
      <h4>Lets mine</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/12.png')}}" alt="start_from_12" />
      <h4>Alpha Forex</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/16.png')}}" alt="rec_16" />
      <h4>Alien limited</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/14.png')}}" alt="start_from_14" />
      <h4>Coinexiss</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/14.png')}}" alt="rec_14" />
      <h4>Excelsiar</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/17.jpg')}}" alt="rec_17" />
      <h4>X-land</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/18.jpg')}}" alt="start_from_18" />
      <h4>Gio Gamer</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/10.png')}}" alt="start_from_10" />
      <h4>Carbon 77</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/15.png')}}" alt="rec_15" />
      <h4>Cointech2u</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/20.png')}}" alt="start_from_20" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/19.png')}}" alt="rec_19" />
      <h4>Elixxon</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/05.png')}}" alt="rec_05" />
      <h4>Slots Market</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/10.png')}}" alt="rec_10" />
      <h4>Foxpay</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/08.png')}}" alt="start_from_08" />
      <h4>Hash blast</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/06.png')}}" alt="rec_06" />
      <h4>Eyen</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/03.png')}}" alt="start_from_03" />
      <h4>Quopi</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/09.png')}}" alt="rec_09" />
      <h4>Galacti Cash</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/15.png')}}" alt="start_from_15" />
      <h4>Banterbits</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/03.png')}}" alt="rec_03" />
      <h4>Xedmex</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/20.png')}}" alt="rec_20" />
      <h4>Future Trade</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/16.png')}}" alt="start_from_16" />
      <h4>Tronscalping</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/18.png')}}" alt="rec_18" />
      <h4>Cen-Trium</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/19.png')}}" alt="start_from_19" />
      <h4>Charge spot</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/detail_rec/07.png')}}" alt="rec_07" />
      <h4>Specta App</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/04.jpg')}}" alt="start_from_04" />
      <h4>City Trade Market</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg')}}" alt="round-right-arrow" />
      </p>
