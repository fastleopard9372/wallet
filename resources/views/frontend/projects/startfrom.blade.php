...
<body>
  ...
  <div class="detail_rec_result">
    <h3>Start From 10$ (20 Results)</h3>
  </div>

  <section class="detail_rec">
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/01.png') }}" alt="start_from_01" />
      <h4>Foxpay</h4>
      <p>
        More infomation
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/02.png" alt="start_from_02') }}" />
      <h4>Future Trade</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/05.png') }}" alt="start_from_05" />
      <h4>Alien Limited</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/06.png') }}" alt="start_from_06" />
      <h4>G-miner</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/07.png') }}" alt="start_from_07" />
      <h4>X-weeks</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/13.png') }}" alt="start_from_13" />
      <h4>Xedmex</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
    ...
    <div>
      <img src="{{ URL::asset('frontend/images/project/startfrom/17.png') }}" alt="start_from_17" />
      <h4>Mila Finance</h4>
      <p>
        More infomation
        <img src="{{ URL::asset('frontend/images/project/round-right-arrow.svg') }}" alt="round-right-arrow" />
