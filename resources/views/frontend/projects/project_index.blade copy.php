...
<body>
  <section class="project_header">
    ...
    <div class="selects">
      <a href="{{ route('detail_rec')}}">Crypto Project</a>
      <a href="{{ route('nft')}}">NFT</a>
      <a href="{{ route('aibot')}}">AI Bot</a>
    </div>
  ...
  <section id="rated" class="rated">
    ...
    <div class="rating_list">
      <a href="/projects/detail/wintonfinance.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/01.jpg" alt="toprated_01" width="100%" />
      ...
      <a href="/projects/noreview.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/02.jpg" alt="toprated_02" width="100%" />
      ...
      <a href="/projects/noreview.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/03.jpg" alt="toprated_03" width="100%" />
      ...
      <a href="/projects/detail/slotsmarket.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/04.jpg" alt="toprated_04" width="100%" />
      ...
      <a href="/projects/detail/galacti_cash.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/05.jpg" alt="toprated_05" width="100%" />
      ...
      <a href="/projects/detail/minebubble.html">
        <div class="pos_rel">
          <img src="/public/images/project/toprated/06.jpg" alt="toprated_06" width="100%" />
          <div class="rating_star">3.5 ⭐</div>
        </div>
        <div class="rate_border">
          <h3>Mine bubbl</h3>
  ...
  <div class="section_padding">
    <div class="ad_panel_4">
      <img src="/public/images/project/advertisement/4_1.jpg" alt="4_1" width="100%" />
      <img src="/public/images/project/advertisement/4_2.jpg" alt="4_2" width="100%" />
      <img src="/public/images/project/advertisement/4_3.jpg" alt="4_3" width="100%" />
      <img src="/public/images/project/advertisement/4_4.jpg" alt="4_4" width="100%" />
      <img src="/public/images/project/advertisement/4_5.jpg" alt="4_5" width="100%" />
      <img src="/public/images/project/advertisement/4_6.jpg" alt="4_6" width="100%" />
    </div>
  </div>

  <section id="recommend_list" class="recommend_list">
    <a href="/projects/detail/giogame.html" class="recom">
      <div><img src="/public/images/project/recommend/recom1.jpg" alt="recom1" width="100%" /></div>
      <div>
        <h3>Gio Gamer</h3>
        <div>
          <div>
            <img src="/public/images/project/star.svg" alt="star" />
            <img src="/public/images/project/star.svg" alt="star" />
            <img src="/public/images/project/star.svg" alt="star" />
            <img src="/public/images/project/star.svg" alt="star" />
            <img src="/public/images/project/star.svg" alt="star" />
          ...
          <div class="ins_available">
            <img src="/public/images/project/plus.svg" alt="plus" />
            &nbsp;Insurance Available
          </div>
        </div>
        <div>Start From 10$</div>
    ...
    <a href="/projects/noreview.html" class="recom">
      <div><img src="/public/images/project/recommend/recom2.jpg" alt="recom2" width="100%" /></div>
      <div>
        <h3>Royal Q Bot</h3>
        <div>
          <div>
    ...
    <a href="/projects/noreview.html" class="recom">
      <div><img src="/public/images/project/recommend/recom3.jpg" alt="recom3" width="100%" /></div>
      <div>
        <h3>X - Land</h3>
        <div>
          <div>
    ...
    <a href="/projects/noreview.html" class="recom">
      <div><img src="/public/images/project/recommend/recom4.jpg" alt="recom4" width="100%" /></div>
      <div>
        <h3>Ufmaa</h3>
        <div>
          <div>
    ...
    <a href="/projects/detail/elixxon.html" class="recom bottom_border">
      <div>
        <img src="/public/images/project/recommend/recom5.jpg" alt="recom5" width="100%" />
      </div>
      <div>
        <h3>Elixxon</h3>
        <div>
    ...
    <a href="/projects/noreview.html" class="recom bottom_border">
      <div><img src="/public/images/project/recommend/recom6.jpg" alt="recom6" width="100%" /></div>
      <div>
  ...
  <div class="headline">
    <img src="/public/images/project/headline.jpg" alt="headline" width="100%" />
  </div>
  ...
  <div class="disclaimer">
    ...
    investors to earn money for long term without any risks. Which is called <a href="/wallet/">"X-wallet"</a>,
    powered by wallet grow. You can directly invest your funds to <a href="/wallet/">X-wallet</a>, Wallet Grow team
    will invest your funds to various crypto sectors and our team will take over time and risks management. Daily
    income can be withdrawn at any time. <a href="/wallet/">X-wallet</a> is high trusted and reliable program.
  </div>
