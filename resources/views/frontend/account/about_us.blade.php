...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">About Us</div>
  </section>

  <!-- About Us -->
  <section class="about_us">
    <div class="about_item">
      <div class="about_title">ROYAL.WIN</div>
      <div class="about_content">
        ROYAL.WIN provide choice of sports Entertainment, finance, casino, cards and slots, We offer our clients a
        wealth of Entertainment across the full range of sports like football, tennis , backetball, snooker and table
        tennis. You can access our APP for you phone or tablet at the same time.
      </div>
    </div>
    <div class="about_item">
      <div class="about_title">ROYAL.WIN culture</div>
      <div class="about_content">
        NEW: Provide whole new experience and enjoyment to clients. Follow Your Heart! <br />
        heart: Attentive service <br />
        Reputation: We believe that integrity can hold member's heart more than coins
      </div>
    </div>
    <div class="about_item">
      <div class="about_title">Philosophy</div>
      <div class="about_content">
        Get the trust and Support of the public with dedicated and professional services.
      </div>
    </div>
    <div class="about_item">
      <div class="about_title">Honesty</div>
      <div class="about_content">
        As an international professional online Entertainment game operator, we are committed to providing each
        customer with the safest and fairest Entertainment games and a full range of services. The result of the game
