...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Finance Record</div>
  </section>

  <!-- Finance Record -->
  <section class="finance_record">
    <div class="finance_record_header">
    ...
    <div class="finance_record_list">
      @foreach($data as $item)
      <div class="finance_record_item">
        <div class="finance_record_time">
          <?php
            $day = date('m/d', strtotime($item->created_at));
            $time = date('H:i:s', strtotime($item->created_at));
            $kind = 'Pledge';
            $class_name = 'plus_mark';
            if ($item->wallet_action == 1) {
              $kind = 'Pledge';
              $class_name = 'plus_mark';
            } else if ($item->wallet_action == 2) {
              $kind = 'non Pledge';
              $class_name = 'plus_mark';
            }
        ...
        <div class="finance_record_content">
          <div class="border_bottom">
            <div class="content">
              <div>{{$kind}}</div>
              <div class="{{$class_name}}">{{$item->amount}}</div>
            </div>
          </div>
        </div>
      </div>
