...
<body style="background: radial-gradient(592px at 48.2% 50%, rgba(255, 255, 249, 0.6) 0%, rgb(160, 199, 254) 74.6%)">
  <!-- Header -->
  <section class="account_default_header" style="background-color: inherit; color: inherit">
    <a href="{{route('front.account')}}" class="align_item_center">
      <svg fill="#000" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flexgrow" style="text-align: center">Customer Service Center</div>
  </section>
  ...
  <section class="support">
    <div class="support_info">
      <div style="width: 60%">
        <div class="ft22">Customer service 24/7</div>
        <p class="ft14">
          Our customer service support are 24 hours online to answer your questions. Don't hesitate to contact us.
        </p>
      </div>
      <div style="width: 40%">
        <img src="{{ URL::asset('frontend/images/account/support/ser.png') }}" alt=" tele" style="width: 100%" />
      </div>
    </div>
