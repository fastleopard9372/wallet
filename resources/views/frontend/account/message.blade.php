...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Message</div>
  </section>

  <!-- Messages -->

  <section class="messages ft14">
    <div class="settings">
      <div class="asread">
        <button class="asread_btn">Mark all as read</button>
      </div>
      <div>All time</div>
      <div>All</div>
    </div>
    ...
    <div class="message">
      <div class="message_info">
        <div>Congratulations! You just received Rech...</div>
        <div class="message_time ft10 align_item_center">
