...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Change Login Password</div>
  </section>

  <!-- Change Login Password -->
  <section class="change">
    <div class="change_input align_item_center">
      <span>
    ...
    <div style="width: 100%; padding: 10px">
      <button style="width: 100%; padding: 10px; background-color: #1e1e1e; color: #fff">Submit</button>
    </div>
    <div class="text-center ft12">
