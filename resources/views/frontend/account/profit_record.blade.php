...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Profit Record</div>
  </section>

  <!-- Profit Record -->
  <section class="profit_record ft14">
    <div class="profit_record_header">Profit Record</div>
    <div class="profit_record_list">
      <div class="profit_record_item">
        <div class="profit_record_time">Today</div>
        <div class="profit_record_content">
          <div class="border_left">
            <div>
              <div>ENTERTAINMENT</div>
              <div>COIN. 0</div>
              <div class="ft10">valid entertainment: COIN. 0.0 0 buy</div>
            </div>
            <div>
              <div class="align_item_center">
                <div>
                  <div class="ft12 min_mark">COIN. -2.5</div>
                  <div class="ft10" style="text-align: end">Detail</div>
                </div>
