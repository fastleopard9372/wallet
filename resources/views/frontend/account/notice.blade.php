...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Announcement</div>
  </section>

  <!-- Announcement -->
  <section class="notice" style="background-color: #f5f9fc">
    <div class="notice_header">
      <div>Announcement</div>
      <div>All time</div>
    </div>
    <div class="notice_item">
      <div class="notice_time ft14">
        <span style="color: #fcd670">&#9612;</span>
        2023-10-30
      </div>
      <div class="notice_detail">
        <div class="notice_content">
          <div>Different Login Device</div>
          <div class="ft12">2023-10-30 15:09:22</div>
        </div>
        <div>&#x2B9A;</div>
      </div>
    </div>
