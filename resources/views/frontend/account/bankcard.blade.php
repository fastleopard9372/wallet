...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Bank Card</div>
  </section>
  ...
  <section class="bankcard">
    <div class="bankcard_info">
      ...
      <div class="card_content">
        <div>OTHER</div>
        <div class="ft12">
          <span>3252 2151 187</span><br />
          <span>IFSC: SBIN0002283</span>
        </div>
      </div>
    </div>
    <div class="add_btn">
      <div class="align_item_center">
        ...
        <span style="margin-left: 15px">Add Bank Card</span>
      </div>
