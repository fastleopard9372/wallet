...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Recharge Record</div>
  </section>

  <section class="recharge_record">
    <div class="recharge_record_header">
    ...
    <div class="recharge_record_list">
      @foreach($data as $item)
      <div class="recharge_record_item">
        <div class="recharge_record_time">
          <?php
        ...
        <div class="recharge_record_content">
          <div class="border_left">
            <div>
              <!-- Wallet Transfer Successed -->
              <div>{{$kind}}</div>
              <!-- <div class="ft12">22:54:34</div> -->
            </div>
            <div class="{{$class_name}}">{{$item->coins}}</div>
          </div>
        </div>
      </div>
      @endforeach
