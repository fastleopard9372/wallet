...
<body>
  ...
  <section class="account_default_header">
    ...
    <div class="flexgrow" style="text-align: center">Promotion</div>
  </section>
  ...
  <section class="promotion">
    ...
    <div class="promotion_list">
      <div class="promotion_item">
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_1.png" alt="screen_1" height="100%" /></div>
      </div>
      <div class="promotion_item">
        <div>></div>
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_2.png" alt="screen_1" height="100%" /></div>
      </div>
      <div class="promotion_item">
        <div>></div>
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_3.png" alt="screen_1" height="100%" /></div>
      </div>
      <div class="promotion_item">
        <div>></div>
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_4.png" alt="screen_1" height="100%" /></div>
      </div>
      <div class="promotion_item">
        <div>></div>
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_5.png" alt="screen_1" height="100%" /></div>
      </div>
      <div class="promotion_item">
        <div>></div>
        <div>Aviator Cash Out Extra Bonus</div>
        <div><img src="/investment/public/images/account/Screenshot_6.png" alt="screen_1" height="100%" /></div>
      </div>
    </div>
  </section>
