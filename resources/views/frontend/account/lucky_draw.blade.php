...
<head>
  ...
  <link rel=" stylesheet" href="{{ URL::asset('frontend/css/mobicss') }}" />
  <link rel="stylesheet" href="{{ URL::asset('frontend/css/accocss') }}" />
  ...
  <section class="account_default_header">
    <a href="{{ route('front.account') }}" class="align_item_center">
      ...
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-sc
    <link rel=" stylesheet" href="{{ URL::asset('frontend/css/mobi
css') }}" />
        <link rel="stylesheet" href="{{ URL::asset('frontend/css/acco
css') }}" />
...
css') }}" />
            ...
            <body>
              <!-- Header -->
              <section class="account_default_header">
                <a href="{{ route('front.account') }}" class="align_item_center">scale=1.0" />
...
css') }}" />
                  ...
                  <body>
                    <!-- Header -->
                    <section class="account_default_header">
                      <a href="{{ route('front.account') }}" class="align_item_center">/account.css" />
...
css') }}" />
                        ...
                        <body>
                          <!-- Header -->
                          <section class="account_default_header">
                            <a href="{{ route('front.account') }}" class="align_item_center">css/account/
...
css') }}" />
                                                                  ...
                                                                  <body>
                                                                    ...
                                                                    <section class="account_default_header">
                                                                      <a href="{{ route('front.account') }}"
                                                                        class="align_item_center">
                                                                        <svg fill="#ffffff" height="20px" width="20px"
                                                                      ...
                                                                      <div class="flexgrow" style="text-align: center">
                                                                        Lucky Draw</div>
                                                                    </section>

                                                                    <section class="lucky_draw">
                                                                      <div id="wheelOfFortune">
                                                                        <canvas id="wheel" width="300"
                                                                          height="300"></canvas>
                                                                        <div id="spin">SPIN asd asd asd as dasd as dasd
                                                                          asd asd as d</div>
                                                                      </div>
                                                                    </section>

                                                                    <script src="/investment/public/js/lucky_draw.js">
                                                                    </script>
                                                                  </body>
