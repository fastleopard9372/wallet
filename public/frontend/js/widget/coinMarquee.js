!(function (e) {
  ...
  function (e, t, n) {
    ...
    t.a = {
      ...
      dzd: { id: 3537, name: "Algerian Dinar", symbol: "dzd", token: "د.ج", space: "" },
      ars: { id: 2821, name: "Argentine Peso", symbol: "ars", token: "$", space: "" },
      amd: { id: 3527, name: "Armenian Dram", symbol: "amd", token: "֏", space: "" },
      aud: { id: 2782, name: "Australian Dollar", symbol: "aud", token: "$", space: "" },
      azn: { id: 3528, name: "Azerbaijani Manat", symbol: "azn", token: "₼", space: "" },
      bhd: { id: 3531, name: "Bahraini Dinar", symbol: "bhd", token: ".د.ب", space: "" },
      bdt: { id: 3530, name: "Bangladeshi Taka", symbol: "bdt", token: "৳", space: "" },
      ...
      bgn: { id: 2814, name: "Bulgarian Lev", symbol: "bgn", token: "лв", space: "" },
      khr: { id: 3549, name: "Cambodian Riel", symbol: "khr", token: "៛", space: "" },
      cad: { id: 2784, name: "Canadian Dollar", symbol: "cad", token: "$", space: "" },
      clp: { id: 2786, name: "Chilean Peso", symbol: "clp", token: "$", space: "" },
      cny: { id: 2787, name: "Chinese Yuan", symbol: "cny", token: "¥", space: "" },
      cop: { id: 2820, name: "Colombian Peso", symbol: "cop", token: "$", space: "" },
      crc: { id: 3534, name: "Costa Rican Colón", symbol: "crc", token: "₡", space: "" },
      hrk: { id: 2815, name: "Croatian Kuna", symbol: "hrk", token: "kn", space: "" },
      cup: { id: 3535, name: "Cuban Peso", symbol: "cup", token: "$", space: "" },
      czk: { id: 2788, name: "Czech Koruna", symbol: "czk", token: "Kč", space: "" },
      dkk: { id: 2789, name: "Danish Krone", symbol: "dkk", token: "kr", space: ". " },
      dop: { id: 3536, name: "Dominican Peso", symbol: "dop", token: "$", space: "" },
      egp: { id: 3538, name: "Egyptian Pound", symbol: "egp", token: "£", space: "" },
      eur: { id: 2790, name: "Euro", symbol: "eur", token: "€", space: "" },
      gel: { id: 3539, name: "Georgian Lari", symbol: "gel", token: "₾", space: "" },
      ghs: { id: 3540, name: "Ghanaian Cedi", symbol: "ghs", token: "₵", space: "" },
      ...
      isk: { id: 2818, name: "Icelandic Króna", symbol: "isk", token: "kr", space: "" },
      inr: { id: 2796, name: "Indian Rupee", symbol: "inr", token: "₹", space: "" },
      idr: { id: 2794, name: "Indonesian Rupiah", symbol: "idr", token: "Rp", space: " " },
      irr: { id: 3544, name: "Iranian Rial", symbol: "irr", token: "﷼", space: "" },
      iqd: { id: 3543, name: "Iraqi Dinar", symbol: "iqd", token: "ع.د", space: "" },
      ils: { id: 2795, name: "Israeli New Shekel", symbol: "ils", token: "₪", space: "" },
      jmd: { id: 3545, name: "Jamaican Dollar", symbol: "jmd", token: "$", space: "" },
      jpy: { id: 2797, name: "Japanese Yen", symbol: "jpy", token: "¥", space: "" },
      jod: { id: 3546, name: "Jordanian Dinar", symbol: "jod", token: "د.ا", space: "" },
      kzt: { id: 3551, name: "Kazakhstani Tenge", symbol: "kzt", token: "₸", space: "" },
      kes: { id: 3547, name: "Kenyan Shilling", symbol: "kes", token: "Sh", space: "" },
      kwd: { id: 3550, name: "Kuwaiti Dinar", symbol: "kwd", token: "د.ك", space: "" },
      kgs: { id: 3548, name: "Kyrgystani Som", symbol: "kgs", token: "с", space: "" },
      lbp: { id: 3552, name: "Lebanese Pound", symbol: "lbp", token: "ل.ل", space: "" },
      mkd: { id: 3556, name: "Macedonian Denar", symbol: "mkd", token: "ден", space: "" },
      myr: { id: 2800, name: "Malaysian Ringgit", symbol: "myr", token: "RM", space: "" },
      mur: { id: 2816, name: "Mauritian Rupee", symbol: "mur", token: "₨", space: "" },
      mxn: { id: 2799, name: "Mexican Peso", symbol: "mxn", token: "$", space: "" },
      mdl: { id: 3555, name: "Moldovan Leu", symbol: "mdl", token: "L", space: "" },
      mnt: { id: 3558, name: "Mongolian Tugrik", symbol: "mnt", token: "₮", space: "" },
      mad: { id: 3554, name: "Moroccan Dirham", symbol: "mad", token: "د.م.", space: "" },
      mmk: { id: 3557, name: "Myanma Kyat", symbol: "mmk", token: "Ks", space: "" },
      nad: { id: 3559, name: "Namibian Dollar", symbol: "nad", token: "$", space: "" },
      npr: { id: 3561, name: "Nepalese Rupee", symbol: "npr", token: "₨", space: "" },
      twd: { id: 2811, name: "New Taiwan Dollar", symbol: "twd", token: "NT$", space: "" },
      nzd: { id: 2802, name: "New Zealand Dollar", symbol: "nzd", token: "$", space: "" },
      nio: { id: 3560, name: "Nicaraguan Córdoba", symbol: "nio", token: "C$", space: "" },
      ngn: { id: 2819, name: "Nigerian Naira", symbol: "ngn", token: "₦", space: "" },
      nok: { id: 2801, name: "Norwegian Krone", symbol: "nok", token: "kr", space: " " },
      omr: { id: 3562, name: "Omani Rial", symbol: "omr", token: "ر.ع.", space: "" },
      pkr: { id: 2804, name: "Pakistani Rupee", symbol: "pkr", token: "₨", space: " " },
      pab: { id: 3563, name: "Panamanian Balboa", symbol: "pab", token: "B/.", space: "" },
      pen: { id: 2822, name: "Peruvian Sol", symbol: "pen", token: "S/.", space: "" },
      php: { id: 2803, name: "Philippine Peso", symbol: "php", token: "₱", space: "" },
      pln: { id: 2805, name: "Polish Złoty", symbol: "pln", token: "zł", space: "" },
      gbp: { id: 2791, name: "Pound Sterling", symbol: "gbp", token: "£", space: "" },
      qar: { id: 3564, name: "Qatari Rial", symbol: "qar", token: "ر.ق", space: "" },
      ron: { id: 2817, name: "Romanian Leu", symbol: "ron", token: "lei", space: "" },
      rub: { id: 2806, name: "Russian Ruble", symbol: "rub", token: "₽", space: "" },
      sar: { id: 3566, name: "Saudi Riyal", symbol: "sar", token: "ر.س", space: "" },
      rsd: { id: 3565, name: "Serbian Dinar", symbol: "rsd", token: "дин.", space: "" },
      sgd: { id: 2808, name: "Singapore Dollar", symbol: "sgd", token: "S$", space: "" },
      zar: { id: 2812, name: "South African Rand", symbol: "zar", token: "R", space: " " },
      krw: { id: 2798, name: "South Korean Won", symbol: "krw", token: "₩", space: "" },
      ssp: { id: 3567, name: "South Sudanese Pound", symbol: "ssp", token: "£", space: "" },
      ...
      thb: { id: 2809, name: "Thai Baht", symbol: "thb", token: "฿", space: "" },
      ttd: { id: 3569, name: "Trinidad and Tobago Dollar", symbol: "ttd", token: "$", space: "" },
      tnd: { id: 3568, name: "Tunisian Dinar", symbol: "tnd", token: "د.ت", space: "" },
      try: { id: 2810, name: "Turkish Lira", symbol: "try", token: "₺", space: "" },
      ugx: { id: 3570, name: "Ugandan Shilling", symbol: "ugx", token: "Sh", space: "" },
      uah: { id: 2824, name: "Ukrainian Hryvnia", symbol: "uah", token: "₴", space: "" },
      aed: { id: 2813, name: "United Arab Emirates Dirham", symbol: "aed", token: "د.إ", space: "" },
      uyu: { id: 3571, name: "Uruguayan Peso", symbol: "uyu", token: "$", space: "" },
      uzs: { id: 3572, name: "Uzbekistan Som", symbol: "uzs", token: "so'm", space: "" },
      vnd: { id: 2823, name: "Vietnamese Dong", symbol: "vnd", token: "₫", space: "" },
    };
  },
  function (e, t, n) {
    e.exports = n(15);
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      return new Promise(function (t, l) {
        ...
        if (
          (m.open(e.method.toUpperCase(), i(C, e.params, e.paramsSerializer), !0),
          (m.timeout = e.timeout),
  ...
  function (e, t, n) {
    "use strict";
    t.a = {
      development: { url: { api: "api", widgetApi: "/widget-api" } },
      production: {
        url: {
  ...
  function (e, t, n) {
    var r = (function (e) {
      ...
      return (
        (C.prototype = k.constructor = y),
        (y.constructor = C),
        (y[s] = C.displayName = "GeneratorFunction"),
  ...
  function (e, t, n) {
    ...
    function c(e, t) {
      for (var n = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== d ? (a[d].references++, a[d].updater(p)) : a.push({ identifier: l, updater: C(p, t), references: 1 }),
          r.push(l);
      }
      return r;
    }
  ...
  function (e, t, n) {
    ...
    var r = n(2),
      ...
      m = function (e, t) {
        ...
        n.setAttribute(
          "class",
          "coin-marquee-wrapper coin-marquee-wrapper--"
            .concat(e, " ")
            .concat(t ? "coin-marquee-wrapper--transparent" : "")
        );
        var r =
            ...
            .concat(
              (function () {
                ...
                for (var t = document.createDocumentFragment(), n = 0; n < 3; n++) {
                  ...
                  r.setAttribute("class", "coin-marquee-item"),
                    (r.innerHTML =
      ...
      f = function (e, t, n) {
        ...
        return (
          i.appendChild(a),
          r &&
            ((i.style.animationDuration = "".concat(o, "s")),
            (i.style.animationName = "marquee-scroll"),
      ...
      h = function (e, t, n) {
        ...
        var p = n
            ? "\n    <div class='coin-marquee-item__icon'>\n      <img src='https://s2.coinmarketcap.com/static/img/coins/32x32/".concat(
                r,
                ".png' />\n    </div>\n  "
              )
            : "",
          m = "\n    <a class='coin-marquee-item-inner' href='https://coinmarketcap.com/currencies/"
            .concat(a, "' title='")
            .concat(o, "' target='_blank'>\n      ")
            .concat(
              p,
              "\n      <div class='coin-marquee-item-info'>\n        <div class='coin-marquee-item-info__row'>\n          <div class='coin-marquee-item-name'>"
            )
            .concat(o, "</div>\n          <div class='coin-marquee-item-price'>")
            .concat(
              l,
              "</div>\n        </div>\n        <div class='coin-marquee-item-info__row'>\n          <div class='coin-marquee-item-symbol'>"
            )
            .concat(i, "</div>\n          <div class='coin-marquee-item-changes ")
            .concat(
              c > 0 ? "coin-marquee-item-changes--up" : "coin-marquee-item-changes--down",
              "'>\n            <span class='coin-marquee-item-changes__icon'></span>"
            )
            .concat(c, "%\n          </div>\n        </div>\n      </div>\n    </a>\n  ");
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                case 0:
                  return (
                    (t = Object.values(d.a)),
                    (n = document.getElementById("coinmarketcap-widget-marquee")),
                    (r = n.getAttribute("coins")),
                    (i = n.getAttribute("currency")),
                    void 0 ===
                      (a = t.find(function (e) {
                        return e.symbol.toUpperCase() === i;
                      })) && (a = t[0]),
                    (s = n.getAttribute("theme")),
                    (u = "true" === n.getAttribute("transparent")),
                    (h = "true" === n.getAttribute("show-symbol-logo")),
                    n.appendChild(m(s, u)),
                    (e.next = 12),
                    c.a.get("".concat(l.a.production.url.widgetApi, "?id=").concat(r, "&convert_id=").concat(a.id))
                  );
                case 12:
                  (C = e.sent),
                    (y = Object.values(C.data.data)),
                    220,
                    (g = y.length),
                    100,
                    (b = (v = 220 * g) / 100),
                    (k = n.querySelector("#coin-marquee-container")),
