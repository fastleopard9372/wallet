!(function (e) {
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      return new Promise(function (t, l) {
        ...
        if (
          (f.open(e.method.toUpperCase(), i(C, e.params, e.paramsSerializer), !0),
          (f.timeout = e.timeout),
  ...
  function (e, t, n) {
    var r = (function (e) {
      ...
      return (
        ...
        (y.constructor = C),
        (y[c] = C.displayName = "GeneratorFunction"),
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = y), c in e || (e[c] = "GeneratorFunction")),
  ...
  function (e, t, n) {
    ...
    function s(e, t) {
      for (var n = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== p ? (a[p].references++, a[p].updater(d)) : a.push({ identifier: l, updater: C(d, t), references: 1 }),
          r.push(l);
      }
      return r;
    }
  ...
  function (e, t, n) {
    ...
    var r = n(2),
      ...
      h = function (e, t, n) {
        ...
        var p = n
            ...
            : "",
          d = "\n    "
            .concat(p, "\n    <div class='coinPriceBlock__title' style='font-size:")
            .concat(o.length >= 12 ? "14" : "16", "px;'>\n      <a href='https://coinmarketcap.com/currencies/")
            .concat(i, "' target='_blank'>\n        ")
            .concat(o, "\n      </a>\n    </div>\n    <div class='coinPriceBlock__price'>")
            .concat(s, "</div>\n    <div class='coinPriceBlock__changes ")
            .concat(
              c > 0 ? "coinPriceBlock__changes--up" : "coinPriceBlock__changes--down",
    ...
    var C = function (e, t, n) {
      ...
      r.setAttribute("id", "coinPriceBlock-wrapper"),
        r.setAttribute(
          "class",
          "coinPriceBlock-wrapper "
            .concat(n ? "coinPriceBlock-wrapper--transparent" : "", " coinPriceBlock-wrapper--")
            .concat(t)
        );
      var o = "coinPriceBlock-container--".concat(t),
        i = "\n    <div id='coinPriceBlock-container' class='coinPriceBlock-container "
          .concat(
            o,
            "'>\n      <span id='coinPriceBlock-loading' class='loading-text'>Widget Loading...</span>\n    </div>\n    <div class='coinPriceBlock-footer'>\n      <div class='coinPriceBlock-currency'>\n        <img src='https://s2.coinmarketcap.com/static/cloud/img/flags/"
          )
          .concat(
            f.a[e.toLocaleLowerCase()],
          ...
          .concat(
            (function (e) {
              var t = "";
              return (
                Object.keys(p.a).forEach(function (n) {
                  if (
                    Object.keys(f.a).findIndex(function (e) {
                      return e === n;
                    }) >= 0
                  ) {
                    var r = p.a[n].symbol.toUpperCase();
                    t += "<option "
                      .concat(e === r ? "selected" : "", " value='")
                      .concat(r, "'>")
                      .concat(r, "</option>");
                  }
                }),
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                case 0:
                  return (
                    (n = Object.values(p.a)),
                    (r = document.getElementById("coinmarketcap-widget-coin-price-block")),
                    (i = r.getAttribute("coins")),
                    (a = r.getAttribute("theme")),
                    (t = t || r.getAttribute("currency")),
                    void 0 ===
                      (c = n.find(function (e) {
                        return e.symbol.toUpperCase() === t;
                      })) && (c = n[0]),
                    (u = "true" === r.getAttribute("transparent")),
                    (d = "true" === r.getAttribute("show-symbol-logo")),
                    (r.innerHTML = ""),
                    r.appendChild(C(t, a, u)),
                    (e.next = 13),
                    s.a.get("".concat(l.a.production.url.widgetApi, "?id=").concat(i, "&convert_id=").concat(c.id))
                  );
                case 13:
                  (f = e.sent),
                    (h = Object.values(f.data.data)),
                    (g = r.querySelector("#coinPriceBlock-container")),
                    (b = m(h, c, d)),
                    g.querySelector("#coinPriceBlock-loading").remove(),
                    (document.querySelector("#currency-select").disabled = !1),
                    g.appendChild(b),
                    document
                      .querySelector(".coinPriceBlock-currency-selector")
